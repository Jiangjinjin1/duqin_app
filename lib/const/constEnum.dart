...
class UserType {
  ...
  static Map typeColor = {
    'VIRTUAL_USER': ColorUtil.un3active,
    'GUEST': ColorUtil.un3active,
    'NORMAL_USER': ColorUtil.un3active,
    'CERTIFICATION_USER': ColorUtil.success,
    'DQ_EXPERT': ColorUtil.info,
    'DQ_SINGER': ColorUtil.danger,
    'DQ_OFFICIAL_ACCOUNT': ColorUtil.active,
    'ADMIN': ColorUtil.warning
  };
  ...
  static Color formColor(String userType) {
    return typeColor[userType] ?? ColorUtil.un3active;
  }
